...
Here's a simple example of how to use the `download_combine_data()` function, which downloads Airbnb data from given URLs, adds metadata (city and weekdays/weekends columns), and combines them into a single data frame.
